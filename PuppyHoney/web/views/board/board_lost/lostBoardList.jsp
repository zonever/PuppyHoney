<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.List, com.lostBoard.model.vo.LostBoard"%>
    <%
    	List<LostBoard> list=(List)request.getAttribute("list");
    %>
    
<%@ include file="/views/common/header.jsp" %>
<<<<<<< HEAD:PuppyHoney/web/views/board/board.lost/lostBoard.jsp
<script>
	$(function(){
		function fn_write(){
...
>>>>>>> master:PuppyHoney/web/views/board/board_lost/lostBoardList.jsp
                    </div>
                    <input type="text" class="form-control" name="inputText" placeholder="검색어 입력">
                    <div class="input-group-append">
